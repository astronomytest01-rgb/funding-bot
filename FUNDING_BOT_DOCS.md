...
10. `/filter`, `/funding`, `/calculator` при выборе нескольких бирж используют только выбранные биржи.
...
13. `/oi` вручную проверяет OI: монета -> биржа -> рекомендация заходить или пропустить.
