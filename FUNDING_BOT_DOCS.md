...
16. Ручной `/longfunding` не использует Gemini; auto job в 21:00 с `GEMINI_API_KEY` фильтрует активы по долгосрочному качеству, исключая мемкоины, микрокапы и высокий риск резких свечей.
