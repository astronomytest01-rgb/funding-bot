...
Ответь строго в таком формате, без вступлений, без заголовков кроме указанных, без markdown кроме переносов строк:

📌 [1 предложение: что за проект и сегмент]

📊 [1 предложение: типичная дневная волатильность и риск иглы при плече]

✅ [1 предложение: брать или нет в дельта-нейтраль, и оптимальное плечо x1/x2/x3/x4]

Максимум 3 строки. Никаких списков, заголовков, нумерации."""
